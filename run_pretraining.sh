python run_pretraining.py --input_file=./records/*.tfrecord  --output_dir=./bert-mini --do_train=True --do_eval=True --bert_config_file=./bert-mini/bert_config.json --train_batch_size=4 --eval_batch_size=4 --max_seq_length=32 --max_predictions_per_seq=2 --learning_rate=1e-4
