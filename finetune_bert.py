...
class Vocab():
    ...
    def build_vocab(self, data):
        ...
        label2name = {0: '艺术', 1: '生活记录', 2: '综艺', 3: '体育', 4: 'null', 5: '航空', 6: '电视剧', 7: '互联网',
                      8: '美妆', 9: '萌宠', 10: '公益', 11: '影视', 12: '星座', 13: '职场', 14: '历史', 15: '时尚',
                      16: '政务', 17: '读书', 18: '育儿', 19: '其他', 20: '法律', 21: '数码', 22: '美图', 23: '汽车',
                      24: '地区', 25: '婚庆', 26: '美食', 27: '军事', 28: '音乐', 29: '健康', 30: '收藏', 31: '直播',
                      32: '家居', 33: 'CP', 34: '明星', 35: '时事', 36: '创意', 37: '搞笑幽默', 38: '搞笑幽默', 39: '教育',
                      40: '房产', 41: '旅游', 42: '电商', 43: '财经', 44: '动漫', 45: 'IT技术', 46: '科普', 47: '校园',
                      48: '设计', 49: '科技', 50: '游戏', 51: '电影', 52: '运动健身', 53: '闲趣', 54: '情感', 55: '行业',
                      56: '社会', 57: '秀场', 58: '摄影'}
...
class WhitespaceTokenizer():
    ...
    def __init__(self):
        vocab_file = osp.join('./bert-mini/vocab.txt')
...
class Optimizer:
    ...
    def get_lr(self):
        lrs = tuple(map(lambda x: x.get_last_lr()[-1], self.schedulers))
        lr = ' %.5f' * self.num
        res = lr % lrs
        return res
...
def sentence_split(text, vocab, max_sent_len=254, max_segment=2):
...
def get_examples(data, word_encoder, vocab, max_sent_len=256, max_segment=2):
